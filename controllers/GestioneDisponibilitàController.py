...
def modificaDisponibilitaTamponi():
    ...
    if 'loggedin' in session:
        ...
        return redirect('/loginFarmacia')
    return render_template('/FarmaciaView/modificaDisponibilitaTamponi.html', tamponi=tamponi, msg=msg, msg_error=msg_error)
    ...
    if 'loggedin' in session:
        if request.method == "POST":
            ...
            try:
                ...
                msg_error = "Tampone già presente nel sistema, se si vuole aggiornare la disponibilità selezionare il tampone corretto"
